...
(deftest identify-four-of-a-kind
  (let [expected {:classification :four-of-a-kind
                  :rank :3
                  :remaining-ranks [:K]
                  :cards #{[:3 :diamonds]
                           [:3 :hearts]
...
(deftest identify-a-straight-flush
  (let [expected {:classification :straight-flush
                  :top-rank :K
                  :suit :hearts
                  :cards [[:K :hearts]
                          [:Q :hearts]
